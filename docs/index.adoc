...
*A step-by-step tutorial for using Enonic XP as a headless CMS*
...
. *Visit the Headless Starter kit* on https://market.enonic.com/vendors/enonic/headless-starter[Enonic Market]
. *Click the* btn:clone
...
. *Click "Applications"* in the launcher menu
. *Click btn:install*
. *Search for and install GraphiQL*
. *Launch GraphiQL* from the launcher menu

Once loaded, GraphiQL, you need to paste the service url into the url field.

****
[NOTE]
====
The default url is http://localhost:8080/portal/draft/hmdb/_/service/com.enonic.starter.headless/graphql
...
image::images/site.png["Add the application to your site"]

TIP: You are free to group your content in folders and tree-structures as desired within a site, just like we do in the HMDB.
...
Follow these steps to remove HMDB, this documentation and samples from your cloned project.
...
* docs/* (This documentation - can be build using `gradle asciidoctor`)
